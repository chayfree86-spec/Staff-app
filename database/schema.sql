...
CREATE TABLE attendance_records (
  ...
  CONSTRAINT fk_attendance_marked_by_business
    FOREIGN KEY (business_id, marked_by) REFERENCES app_users(business_id, id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE staff_transactions (
  ...
  CONSTRAINT fk_transactions_staff_business
    FOREIGN KEY (business_id, staff_id) REFERENCES staff(business_id, id) ON DELETE CASCADE,
  CONSTRAINT fk_transactions_created_by_business
    FOREIGN KEY (business_id, created_by) REFERENCES app_users(business_id, id) ON DELETE SET NULL,
...
CREATE TABLE salary_payouts (
  ...
  CONSTRAINT fk_salary_payouts_staff_business
    FOREIGN KEY (business_id, staff_id) REFERENCES staff(business_id, id) ON DELETE CASCADE,
  CONSTRAINT fk_salary_payouts_created_by_business
    FOREIGN KEY (business_id, created_by) REFERENCES app_users(business_id, id) ON DELETE SET NULL,
...
CREATE TABLE salary_slip_snapshots (
  ...
  CONSTRAINT fk_salary_slips_staff_business
    FOREIGN KEY (business_id, staff_id) REFERENCES staff(business_id, id) ON DELETE CASCADE,
  CONSTRAINT fk_salary_slips_generated_by_business
    FOREIGN KEY (business_id, generated_by) REFERENCES app_users(business_id, id) ON DELETE SET NULL,
